...
The site is built with [Krate](https://kratejs.pages.dev) from [`packages/web/`](packages/web) and deploys via Cloudflare Pages. To work on it locally:

```bash
pnpm install
pnpm --filter @adjskit/web dev    # http://localhost:3000
```
